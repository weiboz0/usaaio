...
Change C7's prerequisite to `C11-neural-training`, which transitively preserves C6 and all of
C7's current prerequisites.
...
Rewrite C7-p10, C7-p24, and C7-p27 as 120-minute training capstones while preserving their
...
All three grade `cnn-training` substantively.
...
C11 manifests 450 lesson minutes, 1,390 practice minutes, and 60 review minutes, for 1,900
minutes total.
C7 changes from 255/672/45 to 345/960/60 lesson/practice/review minutes, a 393-minute increase.
Its four sessions and 27 practices satisfy the existing double-length contract.
Plan 017 therefore adds exactly 2,293 manifested minutes.
...
Manifested time moves from 14,767 to 17,060 minutes and scheduled time from 15,007 to 17,300
...
All 24 new C11 statements and three rewritten C7 statements are original.
